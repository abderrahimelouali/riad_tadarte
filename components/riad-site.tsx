...
const copy = {
  fr: {
    ...
    diningText: 'Le thé est plus qu’une boisson. C’est un moment de partage, de conversation et d’accueil. Découvrez les saveurs du Maroc à table, dans une ambiance simple et chaleureuse.',
    ...
    locationText: 'Riad Tadarte se trouve à Hassi Labied, près de Merzouga, aux portes des dunes du Sahara.',
  ...
  en: {
    ...
    diningText: 'Tea is more than a drink. It is a moment of sharing, conversation and welcome. Enjoy Moroccan flavours at the table, in a simple and warm atmosphere.',
    ...
    locationText: 'Riad Tadarte is in Hassi Labied, near Merzouga, at the gates of the Sahara dunes.',
  ...
  ar: {
    ...
    rates: 'رؤية الأسعار',
    dining: 'نكهة المغرب',
    diningText: 'الشاي أكثر من مشروب؛ إنه لحظة مشاركة وحديث وترحيب. استمتعوا بنكهات المغرب على المائدة في أجواء بسيطة ودافئة.',
    ...
    locationText: 'يقع رياض تادارت في حاسي لبيض قرب مرزوكة، على أبواب كثبان الصحراء.',
...
const translations = {
  ...
  es: {
    ...
    diningText: 'El té es más que una bebida: es un momento para compartir, conversar y dar la bienvenida. Disfrute de los sabores de Marruecos en la mesa, en un ambiente sencillo y cálido.',
